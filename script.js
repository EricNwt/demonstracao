...
function arroz(){
    ...
    economiaarroz.innerHTML = ''
    arrozredeeconomia.innerHTML = '<strong>Rede Economia</strong><br> não tem promoção'
    arrozriosul.innerHTML = '<strong>Rio Sul</strong><br> arroz branco tucano: 19,99R$'
    arrozsupermarket.innerHTML = '<strong>Super Market</strong><br> arroz branco dona elza: 19,95R$'
